...
const Buttons = (props) => {
    ...
    return (
        <div className="btns" >
            ...
            <Button data-target={"add"} classOfButton="btn operator" click={() => props.clicked("+")}>+</Button> 
            ...
            <Button data-target={"substract"} classOfButton="btn operator" click={() => props.clicked("-")}>-</Button> 
            ...
            <Button data-target={"multiply"} classOfButton="btn operator" click={() => props.clicked("*")}>*</Button> 
            ...
            <Button data-target={"divide"} classOfButton="btn operator" click={() => props.clicked("/")}>/</Button>
